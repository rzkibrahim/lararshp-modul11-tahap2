    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <h1 class="text-2xl font-bold text-gray-900">Kode Tindakan Terapi</h1>
                <nav class="flex space-x-4 items-center">
                    ...
                    <span class="text-gray-400">/</span>
                    <span class="text-gray-600">Kode Tindakan Terapi</span>
                </nav>
            </div>
        </div>
    </header>
                ...
                <table class="min-w-full border-collapse">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="p-4 text-left font-semibold text-gray-700">Nama Tindakan</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-blue-50 transition duration-150">
                            ...
                            <td class="p-4 text-gray-800">{{ $item->kategori->nama_kategori ?? '-' }}</td>
                            <td class="p-4 text-gray-800">{{ $item->kategoriKlinis->nama_kategori_klinis ?? '-' }}</td>
                            <td class="p-4">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('admin.kode-tindakan-terapi.destroy', $item->idkode_tindakan_terapi) }}" 
                                          method="POST" 
                                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus kode tindakan/terapi ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
