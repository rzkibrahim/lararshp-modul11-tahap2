    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <h1 class="text-2xl font-bold text-gray-900">Jenis Hewan</h1>
                <nav class="flex space-x-4 items-center">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-2 w-64 bg-white rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-10 border border-gray-200">
                            <div class="py-2">
                                <a href="{{ route('admin.jenis-hewan.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 bg-blue-50 text-blue-600">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-700 to-blue-600 px-6 py-4">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-semibold text-white">Data Jenis Hewan</h2>
                    <div class="flex items-center space-x-4">
                        <span class="text-blue-100">Total: {{ $jenisHewan->count() }} jenis hewan</span>
                ...
                <table class="min-w-full border-collapse">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="p-4 text-left font-semibold text-gray-700">ID Jenis Hewan</th>
                            <th class="p-4 text-left font-semibold text-gray-700">Nama Jenis Hewan</th>
                            <th class="p-4 text-left font-semibold text-gray-700">Jumlah Ras</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-blue-50 transition duration-150">
                            ...
                            <td class="p-4 text-gray-800 font-medium">{{ $item->idjenis_hewan }}</td>
                            <td class="p-4 text-gray-800">{{ $item->nama_jenis_hewan }}</td>
                            <td class="p-4">
                            ...
                            <td class="p-4">
                                <div class="flex gap-2">
                                    ...
                                    <form action="{{ route('admin.jenis-hewan.destroy', $item->idjenis_hewan) }}" 
                                          method="POST" 
                        ...
                        <tr>
                            <td colspan="5" class="p-8 text-center text-gray-500">
                                ...
                                <p class="text-lg">Tidak ada data jenis hewan</p>
                                <a href="{{ route('admin.jenis-hewan.create') }}" 
